  ...
  return (
    <aside className="w-72 shrink-0 border-l border-gray-200 bg-white overflow-y-auto flex flex-col">
      <div className="px-4 pt-4 pb-3 border-b border-gray-100">
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Propriétés</p>
        <p className="mt-1 text-sm font-semibold text-gray-800">{data.label as string}</p>
      </div>
        ...
        {(type === 'send_email' || type === 'send_sms' || type === 'send_whatsapp' || type === 'send_postal') && (
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-800 placeholder-gray-300 outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition"
            />
        ...
        {type === 'delay' && (
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-800 outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition"
            />
          </div>
        )}
          ...
          <>
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-800 outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition bg-white"
              >
      ...
      {type !== 'start' && (
        <div className="p-4 border-t border-gray-100">
          <button
            onClick={deleteNode}
            className="w-full rounded-lg border border-red-200 px-3 py-2 text-sm font-medium text-red-500 transition hover:bg-red-50"
          >
            Supprimer ce node
          </button>
        </div>
